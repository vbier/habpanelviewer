...
public class ConnectedIndicator implements StateUpdateListener {
    ...
    public synchronized void updateFromPreferences(SharedPreferences prefs) {
        boolean intervalChanged = mInterval != Integer.parseInt(prefs.getString("pref_connected_intervall", "60"));

        if (intervalChanged) {
            mInterval = Integer.parseInt(prefs.getString("pref_connected_intervall", "60"));
        }
